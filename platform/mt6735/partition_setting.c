...
struct part_name_map g_part_name_map[PART_MAX_COUNT] = {
	...
	{"frp",		"frp",		"raw data",	19,	0,	0},	
        {"nvdata",       "nvdata",      "ext4",         20,     0,      0},
        {"metadata",     "metadata",    "raw data",     21,     0,      0},	
	{"system",	"system",	"ext4",		22,	1,	1},
	{"cache",	"cache",	"ext4",		23,	1,	1},
	{"userdata",	"userdata",	"ext4",		24,	1,	1},
	{"intsd",	"intsd",	"fat",		25,	0,	0},
	{"otp",		"otp",		"raw data",	26,	0,	0},
	{"flashinfo",	"flashinfo",	"raw data",	27,	0,	0},
	{""},
};
